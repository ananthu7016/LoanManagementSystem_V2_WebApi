           ...
           if(_context != null)
            {
                ...
                if(credentials.RoleId == 2)
                {
                    ...
                    try
                    {
                        ...
                        // so we got the details of the Customer 
                        // then we need to update the Customers Username and Password
                        customer.UserName = credentials.UserName;
                        customer.Password = credentials.Password;
                        // this will set the Password and username to the Updated Password and username 
                ...
                else
                {
                    ...
                    // then using the user_id of the staff we need to get the User Corresponnding to it 

                    User user = new User(); // defining an instance to store the details of the user. 
                    try
                    {
            ...
            return 0; // returns zero as response to indicate that something went wrong .
        }
